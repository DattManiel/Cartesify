...
namespace asgn5v1
{
	...
	public class Transformer : System.Windows.Forms.Form
	{
        ...
        public void Initialize()
        {
            ...
            // Set scale factor relative to window size
            ...
            tnet = MMult(Translate(-axisX, -axisY, 0), UniformScale(sfactor));

            // Reflect because Y coords to make cartesian
            tnet = MMult(tnet, Cartesify());

            // Translate to centre of the window
            this.ctrans = MMult(tnet, Translate(x, y, 0));
        }
         ...
         */
        double[,] UniformScale(double factor)
        {
            double[,] A = new double[4, 4];
        ...
        /*
         * Reflect y-coordinates to make them cartesian 
         */
